...
IGuiPage
{
	...
	IGuiDiagnosticView
	{
		...
		qm_diagViewToolbarPosY: 407
		qm_diagViewToolbarWidth: 743
		qm_diagViewToolbarHeight: 50
		qm_Font.pixelSize: 11
		qm_Font.family: "Tahoma"
		qm_Font.bold: true
		qm_diagViewCornerRadius: 0
			...
			Component
			{
				IGuiListCtrl
				{
					...
					IGuiListHeader
					{
						...
						qm_columnWidthList: [24, 24, 100, 100, 465]
						color: "#ff636973"
		...
		IGuiGraphicButton
		{
			...
			qm_BorderWidth: 1
			qm_ImageSource: "image://QSmartImageProvider/128#2#4#128#0#0"
			qm_Border.top: 15
			qm_Border.bottom: 15
			qm_Border.right: 5
			qm_Border.left: 5
